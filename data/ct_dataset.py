...
class CTDataset(BaseDataset):
    ...
    def __init__(self, opt):
        ...
        # self.A_dir = os.path.join(opt.dataroot, 'VerSe_test', opt.phase)
        # self.B_dir = os.path.join(opt.dataroot, 'mri', opt.phase)
    ...
    def __getitem__(self, index):
        ...
        if self.opt.serial_batches:
            ...
            #A_img = torch.squeeze(A_img, 0)
            #B_img = torch.squeeze(B_img, 0)
